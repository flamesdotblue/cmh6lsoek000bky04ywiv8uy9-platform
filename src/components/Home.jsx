      ...
      <section id="reports" className="py-20 sm:py-24 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {insightsData.slice(0,3).map((item, idx) => (
              <motion.article
                key={item.title}
                initial={{ opacity: 0, y: 16 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 sm:py-24 bg-slate-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="max-w-3xl">
            ...
            <p className="mt-3 text-slate-300">Explore our latest thinking across markets, sectors, and strategies.</p>
          </motion.div>
            ...
            {insightsData.map((item, idx) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <a href="/insights" className="mt-4 inline-flex items-center text-sm font-medium text-teal-300 hover:text-white">
                    View all insights
                    <ArrowRight className="ml-1 h-4 w-4" />
                  </a>
                </div>
